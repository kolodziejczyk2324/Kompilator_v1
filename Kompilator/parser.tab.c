...
void dzielenie_identifier_number(unsigned long long int num);
...
#line 279 "parser.tab.c" /* yacc.c:339  */
...
#line 362 "parser.tab.c" /* yacc.c:355  */
};
...
{
       0,   232,   232,   235,   236,   239,   245,   246,   248,   252,
     254,   257,   257,   267,   269,   271,   267,   276,   279,   276,
     284,   283,   289,   288,   293,   295,   295,   299,   299,   305,
     305,   310,   310,   316,   317,   321,   322,   325,   328,   334,
     335,   336,   337,   341,   342,   343,   344,   348,   349,   350,
     351,   355,   356,   357,   358,   369,   370,   371,   372,   377,
     378,   379,   380,   385,   386,   387,   388,   393,   395,   397,
     399,   405,   407,   409,   411,   420,   425,   430,   435,   442,
     461,   480
};
#endif
...
#line 321 "parser.y" /* yacc.c:1646  */
    {	dodawanie_number_number((yyvsp[-2].ival), (yyvsp[0].ival));		}
...
#line 461 "parser.y" /* yacc.c:1646  */
    {	check_identifier((yyvsp[-3].sval), 1);
							if(jestIterator() && iteratory.find((yyvsp[-1].sval)) != iteratory.end()){ //sprawdz czy dostales iterator jako identyfikator
								if((yyvsp[-3].sval)==stack_iteratory.daj_top()){ //jesli iterator jest tym w ktorym aktualnie jestesmy
									create_number(code, 0, 0); //tutaj bedziemy zapisywac nasz iterator (jego wartosc)
									STORE(4) //zapisujemy go do miejsca w pamieci 0
								}
								else{ //jesli iterator nie jest tym aktualnym z petli to jest on gdzies w pamieci, traktujemy go jak zmienna
									create_number(code, iteratory[(yyvsp[-3].sval)].store, 0); //zapisz w pamieci 0 adres tego iteratora
								}
							}
							else{
